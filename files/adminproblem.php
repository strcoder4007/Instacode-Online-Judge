...
if (isset($_SESSION['loggedin']) && $_SESSION['team']['status'] == 'Admin') {
    if (isset($_GET['code'])) {
        ...
        echo "<div id='list' style='display:none;'><h3>List of Problems</h3><table class='table'><tr><th>ID</th><th>Name</th><th>Score</th><th>Code</th><th>Status</th><th>Options</th></tr>";
        foreach ($res as $row) {
