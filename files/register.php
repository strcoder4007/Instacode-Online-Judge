    ...
    <form method='post' class='form-horizontal'  role="form" onsubmit="return validate()" action='<?php echo SITE_URL; ?>/process.php'>
        <div class='col-lg-12'>
            ...
            <div class='form-group'>
                ...
                <div class='col-lg-4'><input class='form-control' type='text' name='roll1' id='roll1' required data-placement='right' title='Ex : 1302910128'<?php
        ...
        <div class='col-lg-6'>
            ...
            <div class='form-group'>
                ...
                <div class='col-lg-8'><input class='form-control' type='text' name='roll2' id='roll2' data-placement='right' title='Ex : 1302910128'<?php
        ...
        <div class='col-lg-6'>
            ...
            <div class='form-group'>
                ...
                <div class='col-lg-8'><input class='form-control' type='text' name='roll3' id='roll3' data-placement='left' title='Ex : 1302910128'<?php
