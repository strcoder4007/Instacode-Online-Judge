...
printf "\n\nEnter judge.py location [https://raw.githubusercontent.com/aditya6677/mycode/master/judge.py] : "
read JUDGELOC
if [ "$JUDGELOC" = "" ]; then
	JUDGELOC="https://raw.githubusercontent.com/aditya6677/mycode/master/judge.py"
fi
wget $JUDGELOC
